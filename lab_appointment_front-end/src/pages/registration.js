...
export default function Registration() {
  ...
  return (
    <main className="reg-from-center">
      ...
      <span className="page-log-span" ><HiOutlinePencilAlt/></span>
      <h1 className="page-name-h1">Registration</h1>
      </div>
      
      <section className="form-main-continer">
       <div className="form-name-logo-con">
    <div className="form-icon-con"><HiOutlinePencilAlt/></div>
    <div className="form-name-con"><span>Patient Registration</span></div>
       </div>
