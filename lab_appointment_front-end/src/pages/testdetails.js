...
export default function TestDetails() {
  ...
  return (
    ...
    <div className="page-name-spaceholder"></div>
      <span className="page-log-span" ><MdOutlineScience/></span>
      <h1 className="page-name-h1">Test Details</h1>
      </div>
    
    <section className="form-main-continer">
    <div className="form-name-logo-con">
    <div className="form-icon-con"><MdOutlineScience/></div>
    <div className="form-name-con"><span>Patient Test Details</span></div>
       </div>
